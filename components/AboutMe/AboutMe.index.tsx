...
const AboutMe = () => {
  return (
    <div className=" bg-[#020202] pb-[30px] lg:pb-[100px] px-[30px] lg:px-[50px] 2xl:px-[100px] flex flex-col justify-center  gap-[50px]">
      ...
      <div className=" flex flex-col  gap-[20px] lg:gap[70px] ">
        ...
        <p className="text-white text-left lg:leading-8 pt-[10px] text-[20px] font-montserrat   ">
